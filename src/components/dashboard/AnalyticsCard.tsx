...
const AnalyticsCard = ({ title, value, icon }: AnalyticsCardProps) => {
  return (
    <div className="bg-white font-hanken border flex flex-col gap-3 sm:gap-4 border-neutral-300 p-3 sm:p-4 rounded-lg hover:border-neutral-400 transition-all duration-200">
